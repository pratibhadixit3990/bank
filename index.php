...
<body style="background:#B0E0E6;background-size: 100%">
...
<div class="col">
    ...
    <div class="row" style="padding: 22px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/notifications.jpg" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
